...
export const anyelohoyos: Student = {
  ...
  bio: 'Web development student with a great passion for technology and the creation of digital solutions, eager to apply a lot of code..',
