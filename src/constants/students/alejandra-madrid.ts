...
export const alejandraMadrid: Student = {
  ...
  username: 'alejandra-madrid-calderon',

  // EN: Your full name
  // ES: Tu nombre completo
  name: 'Alejandra Madrid Calderón',

  // EN: A short biography about yourself (2-3 sentences)
  // ES: Una biografía corta sobre ti (2-3 oraciones)
  bio: 'I’m Alejandra, a software development student who enjoys learning, improving my skills, and exploring new opportunities in tech.”',
  ...
  profileImage: '/fullstack-course/students/alejandra-madrid/imagen.jpg',

  // EN: Your social media links (optional fields)
  // ES: Tus enlaces de redes sociales (campos opcionales)
  socials: {
    github: 'https://github.com/alejamc14',
    linkedin: 'https://www.linkedin.com/in/alejandra-madrid-15a02a308/',
